...
var Search = function (_React$Component) {
    ...
    (0, _createClass3['default'])(Search, [{
        ...
        value: function render() {
            ...
            return React.createElement(_Input2['default'], (0, _extends3['default'])({ onPressEnter: this.onSearch }, others, { size: size, className: inputClassName, prefixCls: inputPrefixCls, suffix: searchSuffix, theme: 'surround', ref: this.saveInput }));
        }
    }]);
    return Search;
}(React.Component);
