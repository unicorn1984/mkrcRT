    ...
    function Select() {
        ...
        _this.renderSelect = function (locale) {
            ...
            var _a = _this.props,
                ...
                mode = _a.mode,
                theme = _a.theme,
                restProps = __rest(_a, ["prefixCls", "className", "size", "mode", "theme"]);
            var cls = (0, _classnames2['default'])((_classNames = {}, (0, _defineProperty3['default'])(_classNames, prefixCls + '-lg', size === 'large'), (0, _defineProperty3['default'])(_classNames, prefixCls + '-sm', size === 'small'), _classNames), (0, _defineProperty3['default'])({}, prefixCls + '-li', !theme || theme === 'default'), className);
