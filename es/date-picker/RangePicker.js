...
var RangePicker = function (_React$Component) {
    ...
    _createClass(RangePicker, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                'span',
                { ref: this.savePicker, className: classNames(props.className, props.pickerClass), style: _extends({}, style, pickerStyle), tabIndex: props.disabled ? -1 : 0, onFocus: props.onFocus, onBlur: props.onBlur },
                React.createElement(
                    RcDatePicker,
