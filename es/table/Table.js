...
var Table = function (_React$Component) {
    ...
    function Table(props) {
        ...
        _this.renderTable = function (contextLocale) {
            ...
            return React.createElement(RcTable, _extends({ key: 'table' }, restProps, { onRow: _this.onRow, components: _this.components, prefixCls: prefixCls, data: data, columns: columns, showHeader: showHeader, className: classString, expandIconColumnIndex: expandIconColumnIndex, expandIconAsCell: expandIconAsCell }));
        };
